...
@section('tabla')
        ...
        <div class="row mt-3 justify-content-md-around bg-light" id="formulario">
            <form class="m-3" method="POST" action="{{route('guardarActor')}}">
                @csrf
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label class="text-muted" for="validationDefault01">First name</label>
                        <input type="text" class="form-control bg-info text-white" name="first_name" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="validationDefault02">Last name</label>
                        <input type="text" class="form-control bg-info text-white" name="last_name" required>
                    </div>
                </div>
               {{-- <div class="custom-file">
                ...
                <button type="submit" id="actualizar-actor" class="btn btn-info">Añadir</button>
                </div>
            </form>
        </div>
